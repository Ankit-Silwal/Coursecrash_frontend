...
export default function DashboardPage() {
  ...
  const handleLogoutAll = async () => {
    try {
      ...
      console.error('Logout all devices failed:', err.response?.data || err.message)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      {/* Navbar */}
      <nav className="bg-slate-900/80 backdrop-blur border-b border-slate-700 relative z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3 relative">
            <button
              ...
              className="px-4 py-2 rounded-lg bg-slate-700 hover:bg-slate-600 transition text-white font-semibold flex items-center gap-2"
            >
            ...
            {settingsOpen && (
              <>
                ...
                ></div>
                <div className="absolute top-full right-0 mt-2 w-56 bg-slate-800 border border-slate-700 rounded-lg shadow-2xl z-50">
                  <div className="py-2">
                    <button
                      onClick={() => {
                      ...
                      className="w-full px-4 py-2 text-left text-white hover:bg-slate-700 transition flex items-center gap-3"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-red-400 hover:bg-slate-700 transition flex items-center gap-3"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
